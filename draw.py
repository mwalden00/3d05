...
def generate_semi( points, cx, cy, cz, r, step ):
    rot = 0
    while rot < .5:
        circ = 0
        while circ < 1:
...
def add_semi( points, cx, cy, cz, r, step ):
    x0 = r + cx
    y0 = cy
...
def add_sphere( points, cx, cy, cz, r, step ):
    matr = generate_sphere([], cx, cy, cz, r, step)
    for p in matr:
        add_point(points,p[0],p[1],p[2])
...
def add_torus( points, cx, cy, cz, r0, r1, step ):
    matr = generate_torus([], cx, cy, cz, r0, r1, step)
    for p in matr:
        add_point(points,p[0],p[1],p[2])
